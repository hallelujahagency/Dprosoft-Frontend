...
@Component({
  selector: 'app-requests-mission',
  templateUrl: './requests-mission.component.html',
  styleUrls: ['./requests-mission.component.css'],
  providers:[NotificationsService, UserService]
})
export class RequestsMissionComponent implements OnInit {
...
get formJustifControl() { return this.formRequestMissionRefused.controls; }
    ...
    /* get list of requests mission */
      ...
      getListOfRequestsMissions(){
        ...
        this.apiUser.getRequestsMission().subscribe((data:any)=>{
   ...
   onSubmit(){
    ...
    refusedMission()
    {
      ...
      this.apiUser.refusedRequestMission(newData)
                          .subscribe((data:any)=>{
                          // this.getListMissions();
                                this.isFormJustif = !this.isFormJustif;
      ...
      openModal(template: TemplateRef<any>, id:string = '', action:string = '') {
          ...
          if(id !== ''){
            ...
            this.requestSelectedConfig = JSON.parse(this.itemSelected.configData);
          }
